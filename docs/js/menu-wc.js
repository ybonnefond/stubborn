...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">stubborn-ws documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="classes-links"' : 'id="xs-classes-links"' }>
                            ...
                            <li class="link">
                                <a href="classes/ErrorRenderer.html" data-type="entity-link" >ErrorRenderer</a>
                            </li>
                            <li class="link">
                                <a href="classes/InvalidRemoveAfterMatchingTimesParameterError.html" data-type="entity-link" >InvalidRemoveAfterMatchingTimesParameterError</a>
                            </li>
                            <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            ...
                            <li class="link">
                                <a href="interfaces/Emitter.html" data-type="entity-link" >Emitter</a>
                            </li>
                            <li class="link">
